...
const LI_PATHS = {
  ...
  'cuboid':          '<path d="m21.12 6.4-6.05-4.06a2 2 0 0 0-2.17-.05L3.95 7.34A2 2 0 0 0 3 9.08v5.84a2 2 0 0 0 .88 1.66l6.05 4.06a2 2 0 0 0 2.17.05l8.95-5.05a2 2 0 0 0 .95-1.74V8.06a2 2 0 0 0-.88-1.66Z"/><path d="M10 22v-8L3.25 9.15"/><path d="m10 14 11.77-6.87"/><path d="M14 4.5 6.5 8.88"/>',
  ...
  'rotate-cw':       '<path d="M21 2v6h-6"/><path d="M21 8a9 9 0 1 0-2.64 6.36L21 12"/>',
  'axis-3d':         '<path d="M4 19V5"/><path d="m4 5 3 3"/><path d="M4 5 1 8"/><path d="M19 20h-9"/><path d="m19 20-3-3"/><path d="m19 20-3 3"/><path d="m14 4 6 6"/><path d="M20 10h-4"/><path d="M20 10v-4"/>',
